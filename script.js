...
const translations = {
    en: {
        ...
        pricing_feat_2: 'Expert-level feedback that improves your track instantly',
        pricing_feat_3: 'Release-ready mastering',
        ...
        req_optional_title: 'Optional (Recommended)',
        req_optional_1: 'Reference track (if you have one)',
        req_optional_2: 'Notes or artistic direction',
        how_desc: 'Simple. Clear. Effective.',
        how_step1_v2: 'Upload your track',
        how_step2_v2: 'Receive detailed professional feedback',
        how_step3_v2: 'Apply improvements',
        how_step4_v2: 'We master your final version',
    ...
    fr: {
        ...
        pricing_feat_2: 'Feedback expert qui améliore votre track instantanément',
        pricing_feat_3: 'Mastering prêt pour la sortie',
        ...
        req_optional_title: 'Optionnel (Recommandé)',
        req_optional_1: 'Track de référence (si vous en avez une)',
        req_optional_2: 'Notes ou direction artistique',
        how_desc: 'Simple. Clair. Efficace.',
        how_step1_v2: 'Uploadez votre track',
        how_step2_v2: 'Recevez un feedback professionnel détaillé',
        how_step3_v2: 'Appliquez les améliorations',
        how_step4_v2: 'Nous masterisons votre version finale',
    ...
    pt: {
        ...
        pricing_feat_2: 'Feedback especializado que melhora sua track instantaneamente',
        pricing_feat_3: 'Mastering pronto para lançamento',
        ...
        req_optional_title: 'Opcional (Recomendado)',
        req_optional_1: 'Track de referência (se tiver uma)',
        req_optional_2: 'Notas ou direção artística',
        how_desc: 'Simples. Claro. Eficaz.',
        how_step1_v2: 'Envie sua track',
        how_step2_v2: 'Receba feedback profissional detalhado',
        how_step3_v2: 'Aplique as melhorias',
        how_step4_v2: 'Nós masterizamos sua versão final',
    ...
    es: {
        ...
        pricing_feat_2: 'Feedback experto que mejora tu track al instante',
        pricing_feat_3: 'Mastering listo para lanzamiento',
        ...
        req_optional_title: 'Opcional (Recomendado)',
        req_optional_1: 'Track de referencia (si tienes una)',
        req_optional_2: 'Notas o dirección artística',
        how_desc: 'Simple. Claro. Efectivo.',
        how_step1_v2: 'Sube tu track',
        how_step2_v2: 'Recibe feedback profesional detallado',
        how_step3_v2: 'Aplica las mejoras',
        how_step4_v2: 'Masterizamos tu versión final',
    ...
    de: {
        ...
        pricing_feat_2: 'Experten-Feedback, das deinen Track sofort verbessert',
        pricing_feat_3: 'Release-fertiges Mastering',
        ...
        req_optional_title: 'Optional (Empfohlen)',
        req_optional_1: 'Referenztrack (falls vorhanden)',
        req_optional_2: 'Anmerkungen oder künstlerische Richtung',
        ...
        how_step3_v2: 'Wende die Verbesserungen an',
        how_step4_v2: 'Wir mastern deine finale Version',
