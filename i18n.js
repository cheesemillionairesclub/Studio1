...
const translations = {
    en: {
        ...
        hero_title: 'Professional mastering, feedback & label support for <span class="text-gradient">DJs</span>, <span class="text-gradient">producers</span> and <span class="text-gradient">labels.</span>',
        hero_subtitle: 'Mastering + Feedback + Labels — all starting at just $1.',
        hero_cta_btn: 'GET STARTED',
        feature_no_bots: 'Studio-Grade Mastering',
        feature_scheduling: 'Expert Feedback & Review',
        feature_strategy: 'Label Submission Support',
        feature_guarantee: 'Money-back guarantee',
        search_badge: 'CHOOSE YOUR TRACK',
        search_title: '<span class="text-green">Submit</span> your track for professional services!',
        search_desc: 'Search for your track and select it to begin.',
        search_tagline: 'Professional quality. Fast turnaround. Honest feedback.',
    ...
    fr: {
        ...
        hero_title: 'Mastering professionnel, feedback & support label pour <span class="text-gradient">DJs</span>, <span class="text-gradient">producteurs</span> et <span class="text-gradient">labels.</span>',
        hero_subtitle: 'Mastering + Feedback + Labels — le tout à partir de seulement 1$.',
        hero_cta_btn: 'COMMENCER',
        feature_no_bots: 'Mastering qualité studio',
        feature_scheduling: 'Feedback & évaluation par des experts',
        ...
        search_title: '<span class="text-green">Soumettez</span> votre track pour des services professionnels !',
        search_desc: 'Recherchez votre morceau et sélectionnez-le pour commencer.',
        search_tagline: 'Qualité professionnelle. Livraison rapide. Feedback honnête.',
        search_placeholder: 'Nom d\'artiste, titre du track ou URL',
    ...
    pt: {
        ...
        hero_title: 'Masterização profissional, feedback & suporte de labels para <span class="text-gradient">DJs</span>, <span class="text-gradient">produtores</span> e <span class="text-gradient">labels.</span>',
        hero_subtitle: 'Masterização + Feedback + Labels — tudo a partir de apenas $1.',
        hero_cta_btn: 'COMEÇAR',
        feature_no_bots: 'Masterização qualidade de estúdio',
        feature_scheduling: 'Feedback & avaliação por especialistas',
        feature_strategy: 'Suporte de submissão para labels',
        feature_guarantee: 'Garantia de devolução',
        search_badge: 'ESCOLHA SUA TRACK',
        search_title: '<span class="text-green">Envie</span> sua track para serviços profissionais!',
        search_desc: 'Pesquise sua música e selecione para começar.',
        search_tagline: 'Qualidade profissional. Entrega rápida. Feedback honesto.',
    ...
    es: {
        ...
        hero_title: 'Masterización profesional, feedback & soporte de sellos para <span class="text-gradient">DJs</span>, <span class="text-gradient">productores</span> y <span class="text-gradient">sellos.</span>',
        hero_subtitle: 'Masterización + Feedback + Sellos — todo desde solo $1.',
        hero_cta_btn: 'EMPEZAR',
        feature_no_bots: 'Masterización calidad estudio',
        feature_scheduling: 'Feedback & evaluación por expertos',
        feature_strategy: 'Soporte de envío a sellos',
        feature_guarantee: 'Garantía de devolución',
        search_badge: 'ELIGE TU TRACK',
        search_title: '¡<span class="text-green">Envía</span> tu track para servicios profesionales!',
        search_desc: 'Busca tu track y selecciónala para comenzar.',
        search_tagline: 'Calidad profesional. Entrega rápida. Feedback honesto.',
    ...
    de: {
        ...
        hero_title: 'Professionelles Mastering, Feedback & Label-Support für <span class="text-gradient">DJs</span>, <span class="text-gradient">Produzenten</span> und <span class="text-gradient">Labels.</span>',
        hero_subtitle: 'Mastering + Feedback + Labels — alles ab nur 1$.',
        hero_cta_btn: 'JETZT STARTEN',
        feature_no_bots: 'Mastering in Studioqualität',
        feature_scheduling: 'Experten-Feedback & Bewertung',
        feature_strategy: 'Label-Einreichungsunterstützung',
        feature_guarantee: 'Geld-zurück-Garantie',
        search_badge: 'WÄHLE DEINEN TRACK',
        search_title: '<span class="text-green">Reiche</span> deinen Track für professionelle Dienste ein!',
        search_desc: 'Suche deinen Track und wähle ihn aus, um zu starten.',
        search_tagline: 'Professionelle Qualität. Schnelle Lieferung. Ehrliches Feedback.',
        search_placeholder: 'Künstlername, Track-Titel oder URL',
        search_btn: 'SUCHEN',
