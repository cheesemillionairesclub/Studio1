...
const translations = {
    ...
    fr: {
        ...
        nav_pricing: 'TARIFS',
        nav_cta: 'COMMENCER',
        hero_badge: 'Nous aidons les artistes à atteindre les plus hauts standards',
    ...
    pt: {
        ...
        nav_pricing: 'PREÇOS',
        nav_cta: 'COMEÇAR',
        hero_badge: 'Ajudamos artistas a alcançar os mais altos padrões',
    ...
    es: {
        ...
        nav_pricing: 'PRECIOS',
        nav_cta: 'EMPEZAR',
        hero_badge: 'Ayudamos a los artistas a alcanzar los más altos estándares',
    ...
    de: {
        ...
        hero_badge: 'Wir helfen Künstlern, die höchsten Standards zu erreichen',
