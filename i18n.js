...
const translations = {
    en: {
        page_title: 'AlphaStudios - Professional Music Services for Artists',
        page_desc: 'Professional mastering, feedback and label submission support for artists and producers.',
        ...
        hero_subtitle: '10+ years of pushing artists up the charts.',
        ...
        search_title: '<span class="text-green">Push</span> your track into Charts!',
        search_desc: 'Search for your track on our platform and select it to begin.',
        search_tagline: 'No shortcuts. No automation. Just real strategy.',
        search_placeholder: 'Artist name, track url',
        search_btn: 'SEARCH',
        search_empty: 'No tracks found on our platform. Try another search term.',
        ...
        campaign_tip_5: 'Make sure your track is properly mixed and ready for professional mastering.',
        ...
        top100_tip_4: 'The artist or label should have at least 7 previous releases on our platform.',
        ...
        top100_tip_6: 'The track must appear in Hype Picks for the genre.',
        ...
        how_step1_desc: 'Find & select your track using our search bar.',
        ...
        how_step3_bullet1: 'Our team processes your order with professional mastering, detailed feedback, and label submission support.',
        ...
        why_card1_title: 'Real Professional Music Services',
        why_card1_text: 'Professional audio mastering with industry-standard tools and experienced engineers.',
        why_card2_title: 'Detailed Feedback',
        why_card2_text: 'Receive comprehensive feedback on your track including mix analysis, arrangement suggestions, and production tips from experienced professionals.',
        why_card3_title: 'Label Submission Support',
        why_card3_text: 'We help you prepare and submit your tracks to relevant labels with proper formatting, metadata, and professional presentation.',
        faq_title: 'Frequently asked questions',
        faq0a_q: 'What happens after I order?',
        faq0a_a: 'Once your order is placed, you will immediately receive an order confirmation email with the final steps to validate your campaign.<br>The process is fast, simple and fully handled by our team.<br><br><strong>Here\'s what happens next:</strong><br><br>1. <strong>Track verification</strong> — Our team reviews your track and confirms the release link to ensure everything is ready for the campaign.<br>2. <strong>Campaign scheduling</strong> — We schedule your promotion according to the selected package to maximize chart impact.<br>3. <strong>Order processing</strong> — Our network begins purchasing your track on our platform following our strategic campaign process.<br>4. <strong>Chart positioning</strong> — As purchases accumulate, your track can start climbing the charts depending on the package and category.<br>5. <strong>Completion notification</strong> — Once the campaign is completed, you will receive a confirmation email.<br><br>That\'s it. Sit back and watch your track gain visibility and chart momentum on our platform.',
        ...
        faq2_a: 'No. AlphaStudios delivers professional mastering, feedback, and label submission services.',
        ...
        footer_desc: 'The #1 music promotion platform on our platform.',
        footer_nav: 'Navigation',
        footer_boost: 'Boost my track',
        footer_how: 'How it works',
        footer_copy: '&copy; 2026 AlphaStudios. All rights reserved.',
        footer_disclaimer: 'AlphaStudios - Professional Music Services.',
        footer_terms: 'Terms of Use',
    },
    fr: {
        page_title: 'AlphaStudios - Services musicaux professionnels pour artistes',
        page_desc: 'Mastering professionnel, feedback et soumission aux labels pour artistes et producteurs.',
        ...
        hero_title: 'Services musicaux professionnelle pour <span class="text-gradient">DJs</span>, <span class="text-gradient">producteurs</span> et <span class="text-gradient">labels.</span>',
        hero_subtitle: '10+ ans \u00e0 propulser les artistes dans les charts.',
        ...
        search_title: '<span class="text-green">Propulsez</span> votre track dans les Charts !',
        search_desc: 'Recherchez votre morceau sur notre plateforme et s\u00e9lectionnez-le pour commencer.',
        search_tagline: 'Pas de raccourcis. Pas d\'automatisation. Juste de la vraie strat\u00e9gie.',
        search_placeholder: 'Nom d\'artiste, URL de track',
        search_btn: 'RECHERCHER',
        search_empty: 'Aucun titre trouv\u00e9 sur notre plateforme. Essayez un autre terme.',
        ...
        campaign_tip_5: 'Hype : Nous sugg\u00e9rons de s\'abonner \u00e0 Hype et de compl\u00e9ter votre profil artiste avec une photo et une bio.',
        ...
        top100_tip_4: 'L\'artiste ou le label doit avoir au moins 7 sorties précédentes sur notre plateforme.',
        ...
        top100_tip_6: 'Le track doit apparaître dans les Hype Picks du genre.',
        ...
        how_step1_desc: 'Trouvez et s\u00e9lectionnez votre track via notre barre de recherche.',
        ...
        how_step2_li3: 'La dynamique des charts',
        ...
        how_step3_bullet1: 'AlphaStudios connecte votre musique à un réseau privé de DJs, producteurs et collectionneurs passionnés de musique électronique, construit en plus de 10 ans dans l\'industrie.',
        ...
        why_card1_title: 'V\u00e9ritable promotion our platform',
        why_card1_text: 'Tous les achats respectent les mécanismes de la plateforme et sont effectués via des comptes clients légitimes.',
        why_card2_title: 'Impact r\u00e9el et mesurable',
        why_card2_text: 'Chaque promotion est structur\u00e9e pour cr\u00e9er un mouvement tangible dans les charts. Notre \u00e9quipe comprend le fonctionnement des charts et d\u00e9ploie les campagnes de mani\u00e8re pr\u00e9cise et strat\u00e9gique.',
        why_card3_title: '100% organique et sans bots',
        why_card3_text: 'Chaque achat est 100% organique, effectué via de vrais comptes vérifiés, avec une traçabilité complète et des reçus vérifiés.\n\nTous les achats respectent les mécaniques de la plateforme et sont effectués via des comptes clients légitimes.',
        faq_title: 'Questions fr\u00e9quentes',
        faq0a_q: 'Que se passe-t-il apr\u00e8s ma commande ?',
        faq0a_a: 'D\u00e8s que votre commande est pass\u00e9e, vous recevrez imm\u00e9diatement un email de confirmation avec les derni\u00e8res \u00e9tapes pour valider votre campagne.<br>Le processus est rapide, simple et enti\u00e8rement g\u00e9r\u00e9 par notre \u00e9quipe.<br><br><strong>Voici ce qui se passe ensuite :</strong><br><br>1. <strong>V\u00e9rification du track</strong> — Notre \u00e9quipe examine votre track et confirme le lien pour s\'assurer que tout est pr\u00eat pour la campagne.<br>2. <strong>Planification de la campagne</strong> — Nous planifions votre promotion selon le package s\u00e9lectionn\u00e9 pour maximiser l\'impact dans les charts.<br>3. <strong>Traitement de la commande</strong> — Notre r\u00e9seau commence \u00e0 acheter votre track sur notre plateforme selon notre processus strat\u00e9gique de campagne.<br>4. <strong>Positionnement dans les charts</strong> — Au fur et \u00e0 mesure que les achats s\'accumulent, votre track peut commencer \u00e0 monter dans les charts selon le package et la cat\u00e9gorie.<br>5. <strong>Notification de fin</strong> — Une fois la campagne termin\u00e9e, vous recevrez un email de confirmation.<br><br>C\'est tout. Installez-vous et regardez votre track gagner en visibilit\u00e9 et en dynamique dans les charts.',
        ...
        faq2_a: 'Non. Les campagnes AlphaStudios reposent sur de vraies strat\u00e9gies de promotion et une exp\u00e9rience dans l\'industrie.',
        ...
        cta_desc: 'Rejoignez des centaines d\'artistes qui utilisent AlphaStudios pour booster leur carri\u00e8re.',
        cta_btn: 'COMMENCER MAINTENANT',
        footer_desc: 'La plateforme #1 de promotion musicale sur notre plateforme.',
        footer_nav: 'Navigation',
        footer_boost: 'Booster ma track',
        footer_how: 'Comment \u00e7a marche',
        footer_copy: '&copy; 2026 AlphaStudios. Tous droits r\u00e9serv\u00e9s.',
        footer_disclaimer: 'AlphaStudios - Services musicaux professionnels.',
        footer_terms: 'Conditions d\'utilisation',
    },
    pt: {
        page_title: 'AlphaStudios - Serviços musicais profissionais para artistas',
        page_desc: 'Impulsione suas tracks em nossa plataforma com o AlphaStudios. Promo\u00e7\u00e3o profissional para DJs, produtores e labels.',
        ...
        hero_title: 'Promo\u00e7\u00e3o profissional em nossa plataforma para <span class="text-gradient">DJs</span>, <span class="text-gradient">produtores</span> e <span class="text-gradient">labels.</span>',
        hero_subtitle: '10+ anos impulsionando artistas nos charts.',
        ...
        search_title: '<span class="text-green">Impulsione</span> sua track nos Charts!',
        search_desc: 'Pesquise sua m\u00fasica em nossa plataforma e selecione para come\u00e7ar.',
        search_tagline: 'Sem atalhos. Sem automa\u00e7\u00e3o. Apenas estrat\u00e9gia real.',
        search_placeholder: 'Nome do artista, URL da track em nossa plataforma',
        search_btn: 'PESQUISAR',
        search_empty: 'Nenhuma track encontrada em nossa plataforma. Tente outro termo.',
        ...
        campaign_tip_5: 'Certifique-se de que sua track está bem mixada e pronta para masterização profissional.',
        ...
        top100_tip_4: 'O artista ou label deve ter pelo menos 7 lançamentos anteriores em nossa plataforma.',
        ...
        top100_tip_6: 'A track deve aparecer nos Hype Picks do gênero.',
        ...
        how_title: 'Como a promo\u00e7\u00e3o AlphaStudios <span class="text-gradient">funciona</span>',
        how_step1_title: 'Encontre sua track',
        how_step1_desc: 'Encontre e selecione sua track usando nossa barra de pesquisa.',
        ...
        how_step2_li3: 'Din\u00e2mica dos charts',
        ...
        how_step3_bullet1: 'AlphaStudios conecta sua música a uma rede privada de DJs, produtores e colecionadores apaixonados por música eletrônica, construída ao longo de mais de 10 anos na indústria.',
        ...
        why_badge: 'POURQUOI ALPHASTUDIOS',
        why_title: 'Por que escolher o AlphaStudios para promover sua m\u00fasica',
        why_subtitle: 'Construa um crescimento consistente',
        why_card1_title: 'Promo\u00e7\u00e3o real em nossa plataforma',
        why_card1_text: 'Todas as compras estão em conformidade com os mecanismos da plataforma e são feitas através de contas legítimas de clientes.',
        why_card2_title: 'Impacto real e mensur\u00e1vel',
        why_card2_text: 'Cada promo\u00e7\u00e3o \u00e9 estruturada para criar movimento tang\u00edvel nos charts. Nossa equipe entende como os charts funcionam e implanta campanhas de forma precisa e estrat\u00e9gica.',
        why_card3_title: '100% org\u00e2nico e sem bots',
        why_card3_text: 'Cada compra é 100% orgânica, feita através de contas verificadas, com total rastreabilidade e recibos verificados.\n\nTodas as compras estão em conformidade com as mecânicas da plataforma e são feitas através de contas legítimas de clientes.',
        faq_title: 'Perguntas frequentes',
        faq0a_q: 'O que acontece depois que eu fa\u00e7o o pedido?',
        faq0a_a: 'Assim que seu pedido for feito, voc\u00ea receber\u00e1 imediatamente um email de confirma\u00e7\u00e3o com os \u00faltimos passos para validar sua campanha.<br>O processo \u00e9 r\u00e1pido, simples e totalmente gerenciado pela nossa equipe.<br><br><strong>Veja o que acontece a seguir:</strong><br><br>1. <strong>Verifica\u00e7\u00e3o do track</strong> — Nossa equipe analisa seu track e confirma o link de lan\u00e7amento em nossa plataforma.<br>2. <strong>Agendamento da campanha</strong> — Agendamos sua promo\u00e7\u00e3o de acordo com o pacote selecionado.<br>3. <strong>Compras reais em nossa plataforma</strong> — Nossa rede come\u00e7a a comprar seu track em nossa plataforma seguindo nosso processo estrat\u00e9gico.<br>4. <strong>Posicionamento nos charts</strong> — Conforme as compras se acumulam, seu track pode come\u00e7ar a subir nos charts.<br>5. <strong>Notifica\u00e7\u00e3o de conclus\u00e3o</strong> — Quando a campanha for conclu\u00edda, voc\u00ea receber\u00e1 um email de confirma\u00e7\u00e3o.<br><br>S\u00f3 isso. Relaxe e veja seu track ganhar visibilidade e impulso nos charts.',
        ...
        faq2_a: 'N\u00e3o. As campanhas AlphaStudios dependem de estrat\u00e9gias reais de promo\u00e7\u00e3o.',
        ...
        cta_desc: 'Junte-se a centenas de artistas que usam AlphaStudios para serviços musicais profissionais.',
        cta_btn: 'COME\u00c7AR AGORA',
        footer_desc: 'A plataforma #1 de promo\u00e7\u00e3o musical em nossa plataforma.',
        ...
        footer_disclaimer: 'AlphaStudios é um serviço promocional independente. AlphaStudios não é afiliado ao AlphaStudios.',
        footer_terms: 'Termos de Uso',
    },
    es: {
        page_title: 'AlphaStudios - Servicios musicales profesionales para artistas',
        page_desc: 'Impulsa tus tracks en nuestra plataforma con AlphaStudios. Promoci\u00f3n profesional para DJs, productores y sellos.',
        ...
        hero_title: 'Promoci\u00f3n profesional en nuestra plataforma para <span class="text-gradient">DJs</span>, <span class="text-gradient">productores</span> y <span class="text-gradient">sellos.</span>',
        hero_subtitle: '10+ a\u00f1os impulsando artistas en los charts.',
        ...
        search_title: '¡<span class="text-green">Impulsa</span> tu track en los Charts!',
        search_desc: 'Busca tu track en nuestra plataforma y selecci\u00f3nala para comenzar.',
        search_tagline: 'Sin atajos. Sin automatizaci\u00f3n. Solo estrategia real.',
        search_placeholder: 'Nombre del artista, URL de track en nuestra plataforma',
        search_btn: 'BUSCAR',
        search_empty: 'No se encontraron tracks en nuestra plataforma. Prueba con otro t\u00e9rmino.',
        ...
        campaign_tip_5: 'Asegúrate de que tu track esté bien mezclada y lista para masterización profesional.',
        ...
        top100_tip_4: 'El artista o sello debe tener al menos 7 lanzamientos previos en nuestra plataforma.',
        ...
        top100_tip_6: 'La track debe aparecer en los Hype Picks del género.',
        ...
        how_title: 'C\u00f3mo funciona la promoci\u00f3n AlphaStudios <span class="text-gradient">Works</span>',
        how_step1_title: 'Env\u00eda tu track',
        how_step1_desc: 'Encuentra y selecciona tu track usando nuestra barra de b\u00fasqueda.',
        ...
        how_step2_li3: 'Din\u00e1mica de charts',
        ...
        how_step3_bullet1: 'AlphaStudios conecta tu música con una red privada de DJs, productores y coleccionistas apasionados de música electrónica, construida durante más de 10 años en la industria.',
        ...
        why_title: 'Por qu\u00e9 elegir AlphaStudios para promover tu m\u00fasica',
        why_subtitle: 'Construye un crecimiento constante',
        why_card1_title: 'Promoci\u00f3n real en nuestra plataforma',
        why_card1_text: 'Todas las compras cumplen con los mecanismos de la plataforma y se realizan a través de cuentas legítimas de clientes.',
        ...
        why_card3_text: 'Cada compra es 100% orgánica, realizada a través de cuentas verificadas, con total trazabilidad y recibos verificados.\n\nTodas las compras cumplen con las mecánicas de la plataforma y se realizan a través de cuentas legítimas de clientes.',
        faq_title: 'Preguntas frecuentes',
        faq0a_q: '\u00bfQu\u00e9 pasa despu\u00e9s de hacer mi pedido?',
        faq0a_a: 'Una vez realizado tu pedido, recibir\u00e1s inmediatamente un email de confirmaci\u00f3n con los \u00faltimos pasos para validar tu campa\u00f1a.<br>El proceso es r\u00e1pido, sencillo y totalmente gestionado por nuestro equipo.<br><br><strong>Esto es lo que sucede despu\u00e9s:</strong><br><br>1. <strong>Verificaci\u00f3n del track</strong> — Nuestro equipo revisa tu track y confirma el enlace de lanzamiento en nuestra plataforma.<br>2. <strong>Programaci\u00f3n de la campa\u00f1a</strong> — Programamos tu promoci\u00f3n seg\u00fan el paquete seleccionado.<br>3. <strong>Compras reales en nuestra plataforma</strong> — Nuestra red comienza a comprar tu track en nuestra plataforma siguiendo nuestro proceso estrat\u00e9gico.<br>4. <strong>Posicionamiento en charts</strong> — A medida que se acumulan las compras, tu track puede empezar a subir en los charts.<br>5. <strong>Notificaci\u00f3n de finalizaci\u00f3n</strong> — Una vez completada la campa\u00f1a, recibir\u00e1s un email de confirmaci\u00f3n.<br><br>Eso es todo. Rel\u00e1jate y observa c\u00f3mo tu track gana visibilidad en los charts.',
        ...
        faq2_q: '\u00bfUsan bots?',
        faq2_a: 'No. Las campa\u00f1as de AlphaStudios se basan en estrategias reales de promoci\u00f3n.',
        ...
        cta_desc: '\u00Únete a cientos de artistas que usan AlphaStudios para servicios musicales profesionales.',
        cta_btn: 'EMPEZAR AHORA',
        footer_desc: 'La plataforma #1 de promoci\u00f3n musical en nuestra plataforma.',
        ...
        footer_disclaimer: 'AlphaStudios - Servicios musicales profesionales.',
        footer_terms: 'Términos de Uso',
    },
    de: {
        page_title: 'AlphaStudios - Professionelle Musikdienste für Künstler',
        page_desc: 'Booste deine Tracks auf unserer Plattform mit AlphaStudios. Professionelle Promotion f\u00fcr DJs, Produzenten und Labels.',
        ...
        hero_title: 'Professionelle Professionelle Musikdienste f\u00fcr <span class="text-gradient">DJs</span>, <span class="text-gradient">Produzenten</span> und <span class="text-gradient">Labels.</span>',
        hero_subtitle: '10+ Jahre, K\u00fcnstler in den Charts nach oben zu bringen.',
        ...
        search_title: '<span class="text-green">Pushe</span> deinen Track in die Charts!',
        search_desc: 'Suche deinen Track auf unserer Plattform und w\u00e4hle ihn aus, um zu starten.',
        search_tagline: 'Keine Abk\u00fcrzungen. Keine Automatisierung. Nur echte Strategie.',
        search_placeholder: 'K\u00fcnstlername, track URL',
        search_btn: 'SUCHEN',
        search_empty: 'Keine Tracks auf unserer Plattform gefunden. Versuche einen anderen Suchbegriff.',
        ...
        campaign_tip_5: 'Hype: Wir empfehlen, Hype zu abonnieren und dein Künstlerprofil mit Bild und Bio zu vervollst\u00e4ndigen.',
        ...
        top100_tip_4: 'Der Künstler oder das Label sollte mindestens 7 frühere Veröffentlichungen auf unserer Plattform haben.',
        ...
        top100_tip_6: 'Der Track muss in den nuestra plataforma Hype Picks des Genres erscheinen.',
        ...
        how_step1_title: 'Reiche deinen nuestra plataforma-Track ein',
        how_step1_desc: 'Finde und w\u00e4hle deinen nuestra plataforma-Track \u00fcber unsere Suchleiste.',
        ...
        how_step3_bullet1: 'Unser Team bearbeitet deine Bestellung mit professionellem Mastering, detailliertem Feedback und Label-Einreichungsunterstützung.',
        ...
        why_title: 'Warum AlphaStudios f\u00fcr deine Musikpromotion w\u00e4hlen',
        why_subtitle: 'Baue beständiges Wachstum auf',
        why_card1_title: 'Echte Professionelle Musikdienste',
        why_card1_text: 'Alle Käufe entsprechen den Plattformmechanismen von our platform und werden über legitime Kundenkonten getätigt.',
        why_card2_title: 'Echter & messbarer Impact',
        why_card2_text: 'Jede Promotion ist strukturiert, um greifbare Chart-Bewegung zu erzeugen. Unser Team versteht, wie Charts funktionieren und setzt Kampagnen pr\u00e4zise und strategisch ein.',
        why_card3_title: '100% organisch & botfrei',
        why_card3_text: 'Jeder Kauf ist 100% organisch, über verifizierte Konten getätigt, mit vollständiger Rückverfolgbarkeit und verifizierten Belegen.\n\nAlle Käufe entsprechen den Plattform und werden über legitime Kundenkonten getätigt.',
        faq_title: 'H\u00e4ufig gestellte Fragen',
        faq0a_q: 'Was passiert nach meiner Bestellung?',
        faq0a_a: 'Sobald Ihre Bestellung aufgegeben wurde, erhalten Sie sofort eine Best\u00e4tigungs-E-Mail mit den letzten Schritten zur Validierung Ihrer Kampagne.<br>Der Prozess ist schnell, einfach und wird vollst\u00e4ndig von unserem Team abgewickelt.<br><br><strong>Das passiert als N\u00e4chstes:</strong><br><br>1. <strong>Track-Verifizierung</strong> — Unser Team \u00fcberpr\u00fcft Ihren Track und best\u00e4tigt den Release-Link.<br>2. <strong>Kampagnenplanung</strong> — Wir planen Ihre Promotion gem\u00e4\u00df dem gew\u00e4hlten Paket.<br>3. <strong>Bestellbearbeitung</strong> — Unser Team beginnt mit der Bearbeitung Ihres Tracks.<br>4. <strong>Chart-Positionierung</strong> — W\u00e4hrend sich die K\u00e4ufe ansammeln, kann Ihr Track in den Charts aufsteigen.<br>5. <strong>Abschlussbenachrichtigung</strong> — Nach Abschluss der Kampagne erhalten Sie eine Best\u00e4tigungs-E-Mail.<br><br>Das war\'s. Lehnen Sie sich zur\u00fcck und beobachten Sie, wie Ihr Track Sichtbarkeit in den Charts gewinnt.',
        ...
        faq2_a: 'Nein. AlphaStudios bietet professionelles Mastering, Feedback und Label-Einreichungsdienste.',
        ...
        cta_desc: 'Schlie\u00dfe dich Hunderten von K\u00fcnstlern an, die AlphaStudios nutzen, um ihre Karriere zu boosten.',
        cta_btn: 'JETZT STARTEN',
        footer_desc: 'Die #1 Musik-Promotion-Plattform auf unserer Plattform.',
        footer_nav: 'Navigation',
        ...
        footer_disclaimer: 'AlphaStudios - Professionelle Musikdienste.',
